...
class Pages:
    ...
    def __init__(self, ctx, *, entries, per_page=12, show_entry_count=True):
        ...
        self.embed = discord.Embed(colour=0x36393E)
...
class HelpPaginator(Pages):
    ...
    async def show_page(self, page, *, first=False):
        ...
        if hasattr(self, '_is_bot'):
            value = f"For more information use {self.prefix}help [command]"
            self.embed.add_field(name='Information:', value=value, inline=False)
